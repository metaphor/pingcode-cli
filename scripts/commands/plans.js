...
function printHelp() {
  console.log([
    ...
    'Examples:',
    '  # 列出项目应用的工作项类型方案',
    '  pingcode plans type-plan-list --project-id PROJECT_ID --compact',
    '  # 查看状态方案中的全部状态',
    '  pingcode plans state-plan-state-list STATE_PLAN_ID --compact',
    '  # 给状态方案添加一条状态流转',
    '  pingcode plans flow-add STATE_PLAN_ID FROM_STATE_ID TO_STATE_ID',
    '',
    'Global options:',
