...
function printHelp() {
  console.log([
    ...
    'Examples:',
    '  # 新建一条构建记录',
    '  pingcode build create --name unit-test --identifier 131 --provider jenkins --status success --start-at 1583290309 --end-at 1583290347 --duration 38',
    '  # 查看构建记录',
    '  pingcode build get BUILD_ID --compact',
    '  # 只更新构建状态（PATCH）',
    '  pingcode build patch BUILD_ID --status failure',
    '',
    'Global options:',
