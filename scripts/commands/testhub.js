...
function printHelp() {
  console.log([
    ...
    '  # 新建用例',
    '  pingcode testhub case-create --library-id LIBRARY_ID --title "登录成功"',
    '  # 为用例创建执行并提交结果',
    '  pingcode testhub run-create --library-id LIBRARY_ID --plan-id PLAN_ID --case-id CASE_ID',
    '  pingcode testhub run-update RUN_ID --status-id STATUS_ID --remark 通过',
    '',
    'Global options:',
