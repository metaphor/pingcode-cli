...
function printHelp() {
  console.log([
    ...
    '  # 新建评审',
    '  pingcode review create --title 登录模块评审 --pilot-id PRODUCT_ID --principal-type idea',
    '  # 给评审添加评审内容',
    '  pingcode review principal-add REVIEW_ID --principal-id IDEA_ID --principal-type idea',
    '',
    'Global options:',
